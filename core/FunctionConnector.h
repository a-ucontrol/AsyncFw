...
/*! \class FunctionConnector FunctionConnector.h <AsyncFw/FunctionConnector>
\brief Provides a sender-to-receivers connection. Receivers can be invoked in their own threads (default behavior). Other tools typically implement this type of communication using callbacks. A callback is a function pointer; if you want a processing function to notify you about an event, you pass a pointer to another function (the callback) into it. The processing function then invokes the callback when necessary.
...
/*! \class FunctionConnectorProtected FunctionConnector.h <AsyncFw/FunctionConnector>
\brief A protected connector where only a single designated sender can emit messages.
...
/*! \class FunctionConnectionGuardList
\brief A helper container that manages multiple FunctionConnectionGuard lifecycles simultaneously. */
